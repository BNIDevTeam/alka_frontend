...
import { getCampaignById } from "@/lib/api/admin";
import { updateCampaignAction } from "../../actions";
import CampaignForm from "./CampaignForm";
import { ArrowLeft, Edit, Calendar, Target } from "lucide-react";
    ...
    <div className="space-y-6">
        ...
        <div className="relative z-10 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Link
              ...
              className="rounded-xl bg-white/20 p-2 backdrop-blur-sm transition-all hover:scale-105 hover:bg-white/30"
            >
      ...
      <CampaignForm
        ...
        defaultValues={{
          ...
          status: campaign.status as "Draft" | "Published" | "Archived" | "Completed",
